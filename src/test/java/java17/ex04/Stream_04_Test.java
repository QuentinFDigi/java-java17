...
public class Stream_04_Test {
    ...
    public void test_of() throws Exception {
        ...
        Stream<String> result = Stream.builder().add("Alexandra").add("Cyril").add("Johnny").add("Marion").add("Sophie").build().map(Object::toString);
    ...
    public void test_builder() throws Exception {
        ...
        Stream<Object> result = Stream.builder().add("Alexandra").add("Cyril").add("Johnny").add("Marion").add("Sophie").build().map(Object::toString);
